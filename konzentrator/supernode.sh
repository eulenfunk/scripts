...
function start {
	...
	${DBG} logger -t bgp-konz-setup "Start: Supernode ${SUPERNODE_NAME} Setup"
	set -x
	...
	# Aktiviere Gateway
	${DBG} logger -t bgp-konz-setup "Ende: Supernode ${SUPERNODE_NAME} Setup"
}


function stop {

	${DBG} logger -t bgp-konz-setup "Start: Supernode ${SUPERNODE_NAME} Teardown"
	...
	set +x 
	${DBG} logger -t bgp-konz-setup "Ende: Supernode ${SUPERNODE_NAME} Teardown"
}
